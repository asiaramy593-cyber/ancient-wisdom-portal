...
export const Route = createFileRoute("/downloads")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://ancient-wisdom-portal.lovable.app/downloads" },
      { property: "og:image", content: "https://ancient-wisdom-portal.lovable.app/og/downloads.jpg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Downloads & Resources — CV, Reading Lists & References · تنزيلات وموارد" },
      { property: "og:locale", content: "en_US" },
      { property: "og:locale:alternate", content: "ar_EG" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Downloads — Dr. Tamer Al-Solahi" },
      { name: "twitter:description", content: "CV, reading lists, and Egyptology research resources." },
      { name: "twitter:image", content: "https://ancient-wisdom-portal.lovable.app/og/downloads.jpg" },
    ],
