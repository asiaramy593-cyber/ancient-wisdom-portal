...
export const Route = createFileRoute("/research")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://ancient-wisdom-portal.lovable.app/research" },
      { property: "og:image", content: "https://ancient-wisdom-portal.lovable.app/og/research.jpg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Research & Publications — Egyptology Studies · الأبحاث والمنشورات" },
      { property: "og:locale", content: "en_US" },
      { property: "og:locale:alternate", content: "ar_EG" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Research Articles — Dr. Tamer Al-Solahi" },
      { name: "twitter:description", content: "Peer-oriented Egyptological research and articles." },
      { name: "twitter:image", content: "https://ancient-wisdom-portal.lovable.app/og/research.jpg" },
    ],
