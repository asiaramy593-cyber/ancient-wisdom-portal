...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://ancient-wisdom-portal.lovable.app/services" },
      { property: "og:image", content: "https://ancient-wisdom-portal.lovable.app/og/services.jpg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Consulting Services — Historical & Archaeological Consultancy · الخدمات" },
      { property: "og:locale", content: "en_US" },
      { property: "og:locale:alternate", content: "ar_EG" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Services — Dr. Tamer Al-Solahi" },
      { name: "twitter:description", content: "Consulting, advisory and lecture services in Egyptology." },
      { name: "twitter:image", content: "https://ancient-wisdom-portal.lovable.app/og/services.jpg" },
    ],
