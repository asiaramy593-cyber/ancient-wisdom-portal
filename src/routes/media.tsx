...
export const Route = createFileRoute("/media")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://ancient-wisdom-portal.lovable.app/media" },
      { property: "og:image", content: "https://ancient-wisdom-portal.lovable.app/og/media.jpg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Media & Lectures — Interviews, Talks & Documentary Consulting · الإعلام والمحاضرات" },
      { property: "og:locale", content: "en_US" },
      { property: "og:locale:alternate", content: "ar_EG" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Media — Dr. Tamer Al-Solahi" },
      { name: "twitter:description", content: "Lectures, interviews, podcasts, and documentary appearances." },
      { name: "twitter:image", content: "https://ancient-wisdom-portal.lovable.app/og/media.jpg" },
    ],
