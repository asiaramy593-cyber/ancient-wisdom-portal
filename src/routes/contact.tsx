...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://ancient-wisdom-portal.lovable.app/contact" },
      { property: "og:image", content: "https://ancient-wisdom-portal.lovable.app/og/contact.jpg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Contact Dr. Tamer Al-Solahi — Research, Consulting & Media Inquiries · تواصل" },
      { property: "og:locale", content: "en_US" },
      { property: "og:locale:alternate", content: "ar_EG" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Contact — Dr. Tamer Al-Solahi" },
      { name: "twitter:description", content: "Get in touch for Egyptology research, consulting, and lectures." },
      { name: "twitter:image", content: "https://ancient-wisdom-portal.lovable.app/og/contact.jpg" },
    ],
