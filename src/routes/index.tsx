...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://ancient-wisdom-portal.lovable.app/" },
      { property: "og:image", content: "https://ancient-wisdom-portal.lovable.app/og/home.jpg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Dr. Tamer Al-Solahi — Ancient Egyptian Archaeology · د. تامر الصوالحي" },
      { property: "og:locale", content: "en_US" },
      { property: "og:locale:alternate", content: "ar_EG" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Dr. Tamer Al-Solahi — Egyptology Researcher" },
      { name: "twitter:description", content: "Researcher in Ancient Egyptian Archaeology and Historical Consultant." },
      { name: "twitter:image", content: "https://ancient-wisdom-portal.lovable.app/og/home.jpg" },
    ],
